...
urlpatterns = patterns('',
    ...
    url(r'^activate/(?P<activationID>\w{0,100})/$', 'registerJSON.views.activate'),
    ...
    url(r'^loginHome/', 'homePage.views.loginHome', name='loginHome'),
    url(r'^logout/', 'logout.views.index'),
    url(r'^cancelAlert/(?P<alertIDTemp>\w{0,100})/$', 'cancelAlert.views.index'),
    url(r'^cancelPage/(?P<alertIDTemp>\w{0,100})/$', 'cancelAlert.views.cancelPage'),
